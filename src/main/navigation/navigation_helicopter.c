...
static void updateAltitudeThrottleController_MC(timeDelta_t deltaMicros) //sibi!!
{
...
bool adjustMulticopterAltitudeFromRCInput(void) //sibi!!
{
...
void setupMulticopterAltitudeController(void) //sibi!!
{
...
void resetMulticopterAltitudeController(void) //sibi!!
{
...
static void applyMulticopterAltitudeController(timeUs_t currentTimeUs) //sibi!!
{
...
bool isMulticopterFlying(void) //sibi!!
{
 ...
 *-----------------------------------------------------------*/
bool isMulticopterLandingDetected(void) //sibi!!
{
 ...
 *-----------------------------------------------------------*/
static void applyMulticopterEmergencyLandingController(timeUs_t currentTimeUs) //sibi!!
{

...
typedef enum {
    ...
    TIM_USE_HC_MOTOR        = (1 << 5),     // woga65: Helicopter motor output, was (1 << 7), now same as FW_MOTOR
    TIM_USE_HC_SERVO        = (1 << 6),     // woga65: Helicopter servo output, was (1 << 8), now same as FW_SERVO
    TIM_USE_LED             = (1 << 24),
    TIM_USE_BEEPER          = (1 << 25),
} timerUsageFlag_e;

...
// #if defined(MATEKF722SE_MC8SERVOS) || defined(MATEKF722MINI_MC8SERVOS)
//    DEF_TIM(TIM3, CH1, PB4,   TIM_USE_MC_MOTOR |                    TIM_USE_FW_SERVO,                    0, 0),   // S1   UP1-2   D(1, 4, 5)
//    DEF_TIM(TIM3, CH2, PB5,   TIM_USE_MC_SERVO |                    TIM_USE_FW_SERVO,                    0, 0),   // S2   UP1-2   D(1, 5, 5)
//    DEF_TIM(TIM3, CH3, PB0,   TIM_USE_MC_SERVO |                    TIM_USE_FW_SERVO,                    0, 0),   // S3   UP1-2   D(1, 7, 5)
//    DEF_TIM(TIM3, CH4, PB1,   TIM_USE_MC_SERVO |                    TIM_USE_FW_SERVO,                    0, 0),   // S4   UP1-2   D(1, 2, 5)

//    DEF_TIM(TIM2, CH1, PA15,  TIM_USE_MC_SERVO |                    TIM_USE_FW_SERVO,                    0, 0),   // S5   UP1-7   D(1, 5, 3) - clash with S2
//    DEF_TIM(TIM2, CH2, PB3,   TIM_USE_MC_SERVO |                    TIM_USE_FW_SERVO,                    0, 0),   // S6   UP1-7   D(1, 6, 3)

//    DEF_TIM(TIM4, CH1, PB6,   TIM_USE_MC_SERVO |                    TIM_USE_FW_SERVO,                    0, 0),   // S7   UP1-6   D(1, 0, 2)

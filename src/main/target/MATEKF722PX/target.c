...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM2, CH3, PB10,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_HC_MOTOR, 0, 0),   // S7   UP1-7   D(1, 1, 3)
    DEF_TIM(TIM2, CH4, PB11,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_HC_MOTOR, 0, 1),   // S8   UP1-7   D(1, 6, 3)

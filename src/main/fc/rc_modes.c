...
bool isRangeActive(uint8_t auxChannelIndex, const channelRange_t *range)
{
    ...
    // assigned to collective pitch is mapped to the throttle RC-channel.
    // The headspeed is used to determine, which amount of collective 
    // pitch is needed to hover. woga65:

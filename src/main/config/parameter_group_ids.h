...
#define PG_PID_ADJUST 1018  // sibi
#define PG_RCDEVICE_CONFIG 1019
#define PG_GENERAL_SETTINGS 1020
#define PG_GLOBAL_FUNCTIONS 1021
#define PG_ESC_SENSOR_CONFIG 1022
